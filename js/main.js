	...
	function loading_step() {
		...
		$('#resources-select-wrapper').fadeOut(500, function() {
			$('#processing-wrapper').fadeIn(500, function() {
				...
				setTimeout(function() { 
					$console_message.html("Searching for Facebook <span class='console-message-connected-item'>" + $console_message_username_msg + "</span> ...");	
					progressBarConsole(18, $('#progressBarConsole'));			
				}, 3000 );
				setTimeout(function() { 
					$console_message.html("Connecting to Facebook <span class='console-message-connected-item'>" + $console_message_username_msg + "</span> on <span class='console-message-connected-item'>" + $console_message_platform_msg + "</span> Platform");	
				...
				setTimeout(function() { 
					$console_message.html("Successfully Connected to Facebook <span class='console-message-connected-item'>" + $console_message_username_msg + "</span>");
				...
				//-------------------------------1 Resurs Start-------------------------------//
				setTimeout(function() { 
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_fut1_msg + "</span> Coin Master Coins");
				...
				setTimeout(function() {
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_fut1_msg + "</span> <span class='console-message-success'>Coin Master Coins Generated Successfully</span>");
				...
				setTimeout(function() { 
					$console_message.html("Generating Packets for Spins");	
				...
				setTimeout(function() { 
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_fut2_msg + "</span> Coin Master Spins");
				...
				setTimeout(function() { 
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_fut2_msg + "</span> <span class='console-message-success'>Coin Master Spins Generated Successfully</span>");
        ...
        if (ChatUserName == '') {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span>  is this your first time here? this is like the only legit fut Spins generator out there');
                        setTimeout(function() {
                            ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], 'guys dont listen to ' + '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span> ' + ' he just wants all Spins and points for himself haha');
